...
const Services = () => {
  ...
  const experiences = [
    ...
    {
      role: 'Professional Attachment (ICT Department)',
    ...
    <section id="featuring" className="featuring">
      <div className="featuring-container">
        ...
        <div className="featuring-header">
          ...
          <p className="featuring-subtitle">A snapshot of my professional journey, leadership, and education</p>
        </div>

        {/* Tabs */}
        <div className="featuring-tabs">
          {['experience', 'leadership', 'education'].map(tab => (
            <button
              key={tab}
